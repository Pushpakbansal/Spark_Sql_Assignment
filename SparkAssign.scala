...
object SparkAssign {
  ...
  def main(args: Array[String]) {
    ...
    val customers= spark.sparkContext.textFile("E:/Spark_Scala/SparkScala_Documents/Customers.txt")
    val orders= spark.sparkContext.textFile("E:/Spark_Scala/SparkScala_Documents/Orders.txt")
    val ordersitem= spark.sparkContext.textFile("E:/Spark_Scala/SparkScala_Documents/Order_items.txt")
...
//    schemaOrdersitems.printSchema()
	...
	// To see the results get the collect method called.
